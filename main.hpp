...
namespace CPU
{
   ...
   //  }
    ...
    { 
      ...
      if ((AF.hi & 0x0F) <= x) { AF.lo = AF.lo | 0b00100000;} else { AF.lo &= 0b11011111;} // Set H if loer nibble does not underflo
      if ( AF.hi <= loNib){ AF.lo = AF.lo | 0b00010000;} else {AF.lo &= 0b11101111;} // Set CY if whole thing does not underflo underflos
      cycles = 4;
    }
    void SUB_b()
    { 
      ...
      if (AF.hi == 0){ AF.lo = AF.lo | 0x80;} else { AF.lo = 0;} // set Z = 0 if == 0
      AF.lo = AF.lo | 0b01000000; // set N
      if ((AF.hi & 0x0F) <= loNib) { AF.lo = AF.lo | 0b00100000;} else { AF.lo &= 0b11011111;} // Set H if loer nibble does not underflo
    ...
    { 
      ...
      AF.lo = AF.lo | 0b01000000; // set N
      if ((AF.hi & 0x0F) <= loNib) { AF.lo = AF.lo | 0b00100000;} else { AF.lo &= 0b11011111;} // Set H if loer nibble does not underflo
      if ( AF.hi < BC.lo){ AF.lo = AF.lo | 0b00010000; } else {AF.lo &= 0b11101111;} // Set CY if whole thing does not underflo underflos
      cycles = 4;
    }
    void SUB_d()
    { 
      ...
      AF.lo = AF.lo | 0b01000000; // set N
      if ((AF.hi & 0x0F) <= loNib) { AF.lo = AF.lo | 0b00100000;} else { AF.lo &= 0b11011111;} // Set H if loer nibble does not underflo
      if ( AF.hi < DE.hi){ AF.lo = AF.lo | 0b00010000; } else {AF.lo &= 0b11101111;} // Set CY if whole thing does not underflo underflos
      cycles = 4;
    }
    void SUB_e()
    { 
